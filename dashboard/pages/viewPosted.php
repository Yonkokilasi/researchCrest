            ...
            <div class="panel panel-default">
                ...
                <table class = "table" align="center" style="width:100%; font-size: 13px;table-layout:fixed;">
                  ...
                  <tr style="margin-bottom:0%">
                    ...
                    <td><b>No. of Sources:</b></td><td> <?php echo $row['numberOfsources'];?>
                        <?php
                        $digital = $row['digitalSources'];
                        if ($digital == "Yes") {
                          echo "(<span>Digital Sources Requested</span>)";
                        } else if ($digital == "No") {
                          echo "";                        
                        } else {
                          echo "invalid";
...
Order nolonger appears under posted...
</div>";
}
?>               
        </div>
