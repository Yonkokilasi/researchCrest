...
$statement = "`order` WHERE orderStatus = 'taken' AND requestWriter != 'writerId'";
$cr = "SELECT * FROM `order` WHERE orderStatus = 'taken' AND requestWriter != 'writerId'";
...
<title>Orders In progress | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Orders In Progress
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Orders In Progress / </small>
            </h3>
        ...
        WHERE orderStatus = 'taken' AND requestWriter != 'writerId' ORDER BY orderId DESC LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: #0BC9F0; font-weight: bolder;">In Progress</td>
        ...
        <td>
        <a href="viewInProgress.php?id=<?=$row["orderId"];?>"> View </a>
        ...
        if ($check<1) {
            echo "There are no orders in progress at the moment";
        }
        ?>
        </td>
        </tr>
