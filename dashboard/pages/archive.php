...
$statement = "`order` WHERE orderStatus = 'paid'";
...
<title>Archived Orders | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Archive
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Archive / </small>
            </h3>
        </div>
        ...
        WHERE orderStatus = 'paid'  ORDER BY orderId DESC  LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: #4F3526; font-weight: bolder;" >Paid</td>
        ...
        <td>
        <a href="viewArchive.php?id=<?=$row["orderId"];?>"> View </a>
