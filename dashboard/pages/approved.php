...
$statement = "`order` WHERE orderStatus = 'done'";
...
<title>Approved Orders | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Approved Orders
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Approved Orders / </small>
            </h3>
        </div>
        ...
        WHERE orderStatus = 'done' ORDER BY orderId DESC  LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: #565059; font-weight: bolder;">Approved</td>
        ...
        <td>
        <a href="viewApproved.php?id=<?=$row["orderId"];?>"> View </a>
