...
$statement = "`order` WHERE orderStatus = 'disputed'";
...
<title>Disputed Orders | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Disputed Orders
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Disputed Orders / </small>
            </h3>
        ...
        WHERE orderStatus = 'disputed'   LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: red; font-weight: bolder;">Disputed</td>
        ...
        <td>
        <a href="viewDisputed.php?id=<?=$row["orderId"];?>"> View </a>
