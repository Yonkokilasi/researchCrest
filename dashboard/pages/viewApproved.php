...
<div id="page-wrapper">
    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / <a href = "approved.php">Approved Orders</a> / View Order</small>
                </h3>
                <?php
                if(mysqli_num_rows(mysqli_query($Con, "SELECT * FROM `order` WHERE orderId = '$orderId' AND orderStatus = 'done'"))>0)
                {            
                ?> 
                        <?php
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
              <form method="POST" action="php/redirect.php?page=viewApproved.php&id=<?=$orderId?>">
...
Order nolonger appears under approved order(s)...
</div>";
}
?>      
        </div>
