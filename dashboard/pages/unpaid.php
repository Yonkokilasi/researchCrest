...
$statement = "`order` WHERE orderStatus = 'unpaid'";
...
<title>Unpaid Orders | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Unpaid Orders
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">DashBoard</a> / Unpaid Orders / </small>
            </h3>
        <?php
        ...
        WHERE orderStatus = 'unpaid' ORDER BY orderId DESC  LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: red;font-weight: bolder;">UNPAID</td>
        ...
        <td>
        <a href="viewUnpaid.php?id=<?=$row["orderId"];?>"> View </a>
...
(1000).fadeOut(10000);
    ...
    <?php
          $sql = "SELECT * FROM `notifications` WHERE userType = 'Support' AND status = 'not viewed'";
            $result = mysqli_query($Con, $sql);
