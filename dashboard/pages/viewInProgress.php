    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / <a href = "progress.php">In Progress</a> / View Order</small>
                </h3>
                        <?php
        ...
        ?>
		<?php
		if(mysqli_num_rows(mysqli_query($Con, "SELECT * FROM `order` WHERE orderId = '$orderId' AND orderStatus = 'taken'"))>0)
		{            
		?>
                ...
                ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="php/messages/sendMsg-progress.php">
            ...
            <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <form method="POST" action="php/redirect.php?page=viewInProgress.php&id=<?=$orderId?>">
...
<!-- /.col-lg-6 -->
		...
		Order nolonger appears under order(s) in progress
		</div>";
		}
		?>       
        </div>
