...
$sql = ("INSERT INTO `r_p_w`.`messaging` (`id`, `orderId`, `sender`, `recipient`, `subject`, `message`, `status`, `time`) VALUES (NULL, '$orderId', 'Support', '$sender', '$subject', '$text_message', 'unread', '$time')");
...
$sql            = "SELECT email, user_name FROM registration WHERE reg_id = '$sender'";
...
$user_name2      = $row['user_name'];
    ...
    <strong>Incident:</strong> New message from admin, kindly login to your account to view<br/>
    <p>&nbsp;</p>
    Cheers,<br/>
