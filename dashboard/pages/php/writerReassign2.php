...
$date2          = date('d M Y H:i:s A');
 ...
 if ($query and $query1 and $send_mail) {

    mysqli_query($Con,"COMMIT");

    $_SESSION['msg']="Writer has been successfully assigned";
	header("location:../viewAssigned.php?id=$orderId#assign");
  ...
  mysqli_close($Con);
	...
	header("location:https://www.researchpaperweb.com/admin/pages/index.php");
}
