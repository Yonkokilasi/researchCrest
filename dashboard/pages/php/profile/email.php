...
if (isset($_POST['cngemail'])) {

mysqli_autocommit($Con,false);

$pass	    = mysqli_real_escape_string($Con, $_POST['password']);
$email 	    = mysqli_real_escape_string($Con, $_POST['writerEmail']);
...
$date2          = date('d M Y H:i:s A');
  ...
  $user_name2      = $row['user_name'];
    ...
    <strong>Incident:</strong> <i>Update of account email</i><br/>
    <strong>New Email:</strong> <i>Order '.$email.'</i><br/>
    <p>&nbsp;</p>
    Cheers,<br/>
 ...
 if ($query and $send_mail) {
    ...
    $_SESSION['msg']="email has been successfully changed...";
