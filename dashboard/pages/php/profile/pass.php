...
$pass2 = md5(sha1($pass2));

$query = mysqli_query($Con, "UPDATE `registration` 
		SET `registration`.password 	= '$pass2'
...
$date2          = date('d M Y H:i:s A');
 ...
 $to       = $account_email2;
    ...
    <strong>Incident:</strong> <i>Your account password has been updated</i><br/>
    <p>&nbsp;</p>
    Cheers,<br/>
 ...
 if ($query and $send_mail) {
   ...
   $_SESSION['msg']="An error occured during processing, please try again...";
	...
	$_SESSION['msg']="passwords you have entered do not match";
	header("location:../../profile.php");
}
