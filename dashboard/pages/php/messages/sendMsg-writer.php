...
if (isset($_POST['submit-msg-student'])) {
    ...
    $writerId	=	mysqli_real_escape_string($Con, $row2['writerId']);
	}else{
	$writerId	=	$recipient;
	}

	$sql = ("INSERT INTO `r_p_w`.`messaging` (`id`, `orderId`, `sender`, `recipient`, `subject`, `message`, `status`, `time`) VALUES (NULL, '$orderId', 'Support', '$writerId', '$subject', '$message', 'unread', '$time')");
...
$sql            = "SELECT email, user_name FROM registration WHERE reg_id = '$writerId'";
