    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / <a href = "bids.php">Bids</a> / View Order</small>
                </h3>
                        <?php
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="php/messages/sendMsg-posted.php">
...
<!-- New Message -->
        <!-- Writer Stats -->
        <div class="modal fade" id="myModalWriter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#assign" data-toggle="tab">Confirm Writer</a>
                        </li>
                    </ul>
...
<!-- /.col-lg-6 -->
        ...
        <table class = "table" align="left" style="width:50%;">
            ...
            <?php
            $sql = "SELECT * FROM `bids` WHERE orderId = '$orderId'";
            $result = mysqli_query($Con, $sql);
            $chec2 = mysqli_num_rows($result);
            while($row=mysqli_fetch_assoc($result)){
            ?>
            <tr>
                ...
                <td>
                    <?php echo $reg_id = $row['writerId']; ?>
                </td>
                <td>
                <a href="#" data-toggle='modal' data-target='#myModalWriter' data-id="<?php echo $reg_id ?>"> 
                Writer Stats
                </a>
                </td>
                <td>
                <form method = "POST" action = "php/writer_Assign.php?id=<?=$reg_id?>&orderId=<?=$orderId?>">
...
$(document).ready(function(){
    $('#myModalWriter').on('show.bs.modal', function (e) {
        var rowid = $(e.relatedTarget).data('id');
        $.ajax({
            type : 'post',
            url : 'php/fetch_record.php', //Here you will fetch records 
