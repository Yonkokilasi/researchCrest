...
<div id="page-wrapper">
    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / <a href = "completed.php">Completed Orders</a> / View Order</small>
                </h3>
				<?php
				if(mysqli_num_rows(mysqli_query($Con, "SELECT * FROM `order` WHERE orderId = '$orderId' AND orderStatus = 'completed'"))>0)
				{            
				?>
                        <?php
                ...
                ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="php/messages/sendMsg-completed.php">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
            <form method="POST" action="php/redirect?page=viewCompleted&id=<?=$orderId?>">
                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <?php
                            ...
                            <li ><a href="#revision" data-toggle="tab">Request Revision</a>
                            </li>                             
                        <li>
                        <form method="POST" action="php/approveOrder.php?id=<?=$orderId ?>">
                            <button id="btn_approve_order" name="approve" class="btn btn-success">Approve order</button>
                        </form>
                        </li>                                                
                    </ul>
...
<!-- /.col-lg-6 -->
        ...
        <div class="tab-pane fade in" id="revision">
        <hr/>
        <div style="width: 70%">
        <form method="POST" action="php/reviseOrder.php">
            <table>
            <tr><td>Reasons</td><td>&nbsp;</td><td>New deadline</td><td>&nbsp;</td> <td>Order Id</td></tr>
            <tr><td> 
            <select name="subject" class="form-control">
            <option>Instructions not followed</option>
            <option>Word count not fulfilled</option>
            <option>Wrong formatting style</option>
            <option>Plagiarism (attach report)</option>
            <option>Other</option>
            </select>
            </td><td>&nbsp;</td>
            <td>
            <select name="deadline" id="deadline" class="form-control">
                <option value="1.1">1 Hour</option>
                <option value="1.0">3 Hours</option>
                <option value="0.9">8 Hours</option>
                <option value="0.8">16 Hours</option>                                
                <option value="0.7">1 Day</option>
                <option value="0.6">2 Days</option>
                <option value="0.5">3 Days</option>
                <option value="0.4">5 Days</option>
                <option value="0.3">7 Days</option>
                <option value="0.2">14 Days</option>
                <option value="0.1">30 Days</option>                                     
            </select>
            </td><td>&nbsp;</td>
            <td><input type="text" name="orderId" readonly="readonly" class="form-control" value="<?php echo $orderId;?>"></td>
            <tr>
            </table>
            <b>Comments*</b>: <textarea name="reasons" class="form-control" placeholder="reasons for revision" style="height: 100px;"></textarea>
            <p>&nbsp;</p>
            <button class="btn btn-outline btn-warning pull-right" type="submit" name="revision">Request Revision</button>
        </form>
        </div>
        </div>					
                </div>
...
Order nolonger appears under completed order(s)...
</div>";
}
?> 		
        </div>
