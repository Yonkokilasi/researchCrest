...
<div id="page-wrapper">
    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / <a href = "disputed.php">Disputed Orders</a> / View Order</small>
                </h3>
				<?php
				if(mysqli_num_rows(mysqli_query($Con, "SELECT * FROM `order` WHERE orderId = '$orderId' AND orderStatus = 'disputed'"))>0)
				{            
				?>
                        <?php
                ...
                ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="php/messages/sendMsg-disputed.php">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
           <form method="POST" action="php/redirect.php?page=viewDisputed.php&id=<?=$orderId?>">
...
<?php
                        ...
                        <li><a href="#settle" data-toggle="tab">Settle Dispute</a>
                        </li>                                                
                    </ul>
...
<!-- /.col-lg-6 -->
        ...
        <!-- .panel-heading -->
                    ...
                    <div class="tab-pane fade in" id="settle">
                        <hr/>
                            <form method="POST" action="php/settle.php?id=<?=$orderId?>">
                            <button type="submit" name="resolve" class="btn btn-primary" >
                            <i class="fa fa-random"></i>
                            Resolve Dispute</button>

                            <button type="submit" name = "refund" class="btn btn-info">
...
Order nolonger appears under disputed order(s)
</div>";
}
?> 		
        </div>
