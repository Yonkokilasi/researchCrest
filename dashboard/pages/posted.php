...
$statement = "`order` WHERE requestWriter = 'writerId' AND orderStatus = 'not taken'";
...
<title>Posted Orders | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Posted Orders
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">DashBoard</a> / Posted Orders / </small>
            </h3>
        <?php
        ...
        WHERE orderStatus = 'not taken' AND requestWriter = 'writerId' ORDER BY orderId DESC  LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: green; font-weight: bolder;">Available</td>
        ...
        <!-- Start of script -->
        <div id="<?php echo $orderId ?>" style="display: none;"><?php echo $Resul; ?></div>
        <script type="text/javascript">
            var div = document.getElementById("<?php echo $orderId ?>");
            var myData = div.textContent;
        
            var goodColor = "#66cc66";
            var badColor = "#ff6666";
            var message = document.getElementById("<?php echo $tyn ?>");
        ...
        <td>
        <a href="viewPosted.php?id=<?=$row["orderId"];?>"> View </a>
        ...
        if ($check<1) {
            echo "There are no posted orders at the moment";
        }
        ?>
        </td>
        </tr>
