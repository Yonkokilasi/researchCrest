...
<title>Available Orders | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Assigned Orders
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Assigned Orders / </small>
            </h3>
        <?php
        ...
        <td style="color: blue; font-weight: bolder;">Assigned</td>
        ...
        <td>
        <a href="viewAssigned.php?id=<?=$row["orderId"];?>"> View </a>
