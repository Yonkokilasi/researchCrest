...
<head>
    ...
    <title>Samples | Research Paper Web</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          ...
          <div id="preloader">
              ...
              <div class="col-lg-12">
                <h3 class="page-header">Samples
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Samples</small>
                </h3>
                <?php
        ...
        ?>
            ...
            <!-- /.col-lg-12 -->
            <div class="col-lg-12">
            <form method="POST" action="new-sample.php">
            ...
            <p>&nbsp;</p>
	        <?php
	        $sql = "SELECT * FROM `samples` ORDER BY id DESC LIMIT {$startpoint} , {$limit};";
	        ...
	        ?>
                    <div class="panel panel-success">
                        ...
                        <form method="POST" action="view-sample.php?url=<?=$sample_url?>" >
