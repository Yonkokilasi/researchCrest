...
$statement = "`order` WHERE orderStatus = 'revision'";
$cr = "SELECT * FROM `order` WHERE orderStatus = 'revision' ";
...
<title>Orders on Revision | Research Paper Web</title>
...
<div id="preloader">
    ...
    <div class="row" >
        <div class="col-lg-12">
            ...
            Revision Orders
            (<?php echo $np;?>)
            <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / Revision Orders / </small>
            </h3>
        ...
        WHERE orderStatus = 'revision'   LIMIT {$startpoint} , {$limit};";
        ...
        <td style="color: #F7193A; font-weight: bolder;">Revision</td>
        ...
        <td>
        <a href="viewRevision.php?id=<?=$row["orderId"];?>"> View </a>
        ...
        if ($check<1) {
            echo "There are no orders on revision at the moment";
        }
        ?>
        </td>
        </tr>
