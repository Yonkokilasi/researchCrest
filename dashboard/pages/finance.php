                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="finance.php#Unrequested" >Unrequested</a>
                            </li>
                            <li><a href="finance-requested.php#Requested">Requested</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="Unrequested">
                            ...
                            <td># <a href="viewApproved.php?id=<?=$row['orderId'];?>"> <?php echo $row['orderId'];?></a> </td>
                            ...
                            *
                            ...
                            <?php if (($orderStatus == 'paid') && ($p_status != 'refunded')) {?>
                             <form method="POST" action="php/refund.php?id=<?=$orderId?>">
