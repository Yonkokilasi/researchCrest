...
$statement = "`order` WHERE orderStatus = '$orderStatus' AND clientId = '$clientId'";
$cr = "SELECT * FROM `registration` WHERE user_type = 'client'";
$tl = mysqli_query($Con, $cr);
$np = mysqli_num_rows($tl);

$cr = "SELECT * FROM `order` WHERE orderStatus = '$orderStatus' AND clientId = '$clientId'";
$tl = mysqli_query($Con, $cr);
$np = mysqli_num_rows($tl);
?>
<!DOCTYPE html>
...
<div id="preloader">
    ...
    <div class="row" >
        ...
        WHERE orderStatus = '$orderStatus' AND clientId = '$clientId'  LIMIT {$startpoint} , {$limit};";
