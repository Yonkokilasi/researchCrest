...
$counter_user = "root";
$counter_password = "";
$counter_database = "customwriting";
...
<div style="width:150px;float:right">
   ...
   <div style="border:1px solid #000000;padding:2px;width:100%;font-size:80%;text-align:left;">
   ...
   <div style="border:1px solid #000000;padding:2px;width:100%;font-size:80%;">
      ...
      <div style="font-size:75%;" align="center"><a href="http://www.customwrotingpros.com" target="_blank">HomeworkCrest</a></div>
   </div>
</div><?php
}
?>