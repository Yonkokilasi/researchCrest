...
<div id="page-wrapper">
    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <small class = "breadcrumb pull-right"><a href = "index.php">Dashboard</a> / <a href = "revision.php">Revision</a> / View Order</small>
                </h3>
				<?php
				if(mysqli_num_rows(mysqli_query($Con, "SELECT * FROM `order` WHERE orderId = '$orderId' AND orderStatus = 'revision'"))>0)
				{            
				?>
                        <?php
                ...
                ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="php/messages/sendMsg-revision.php">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-footer">
            <form method="POST" action="php/redirect.php?page=viewRevision.php&id=<?=$orderId?>">
...
<?php
                        ...
                        <li><a href="#re-assign" data-toggle="tab">Re-assign</a>
                        </li>                                                
                    </ul>
...
<!-- /.col-lg-6 -->
        ...
        <!-- .panel-heading -->
                    ...
                    <div class="alert2 alert-info">
                        <?php
                        $sql9 = "SELECT * FROM `complains` WHERE orderId = '$orderId'";
                        $result9 = mysqli_query($Con, $sql9);
                        while
                        ($row9=mysqli_fetch_assoc($result9)){
                        echo "<strong>".$row9['subject']."</strong><br/>";    
                        echo $row9['reasons']."<br>";
                         }
                        ?>
                        <?php
                        $check9 = mysqli_num_rows($result9);
                        if ($check9<1) {
                            echo "There are no comments on this order at the monent";
                        }
                        ?>
                    </div>
                    </div>
                    <div class="tab-pane fade in" id="re-assign">
                        <hr/>
        <form method="POST" action="php/writerReAssign.php">        
        <?php
        ...
        <table>
            <tr style="border-spacing: 5px">
                ...
                <input type="hidden" name="orderId" value="<?php echo $orderId;?>">                
                    <?php
                      $sql = "SELECT * FROM `registration` WHERE user_type = 'writer' and account_status = 'active' and activation_status = 'active'";
                      $result = mysqli_query($Con, $sql);
...
Order nolonger appears under order(s) on revision
</div>";
}
?> 		
        </div>
