...
function promoCode() {
    ...
    $("#promo_code").attr("value",randomstring);
}
...
var resreshId = setInterval(function()
{
$('.unpaid-orders-sidebar').show().load('process-sidebar/unpaid.php');
}, 1000
);
...
var resreshId = setInterval(function()
{
$('.assigned-orders-sidebar').show().load('process-sidebar/assigned.php');
}, 1000
);
