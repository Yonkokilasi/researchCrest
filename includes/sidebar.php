            ...
            <li>
                <a href="#">
                    ...
                    <ul class="nav nav-second-level orders display-none">
                        ...
                        Posted Orders<span class="pull-right available-orders-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="unpaid.php">
                        <i class="fa fa-bookmark-o fa-fw fa-2x text-danger"></i>
                        Unpaid Orders<span class="pull-right unpaid-orders-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="assigned.php">
                        <i class="fa fa-map-marker fa-fw fa-2x"></i>
                        Assigned Orders<span class="pull-right assigned-orders-sidebar"></span></a>
                        </li>
                         <li>
                        <a href="progress.php">
                        <i class="fa fa-list-ol fa-fw fa-2x"></i>
                        Orders in Progress<span class="pull-right orders-in-progress-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="disputed.php">
                        <i class="fa fa-question-circle fa-fw fa-2x"></i>
                        Disputed Orders<span class="pull-right disputed-orders-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="revision.php">
                        <i class="fa fa-info-circle fa-fw fa-2x"></i>
                        Orders on Revision<span class="pull-right order-revision-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="completed.php">
                        <i class="fa fa-check-square-o fa-fw fa-2x"></i>
                        Completed Orders<span class="pull-right completed-orders-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="approved.php">
                        <i class="fa fa-check-square-o fa-fw fa-2x"></i>
                        Approved Orders<span class="pull-right approved-orders-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="archive.php">
                        <i class="fa fa-flag-checkered fa-fw fa-2x"></i>
                        Archive<span class="pull-right"></span></a>
                        </li>
            ...
            <li>
                <a href="#">
                    ...
                    <ul class="nav nav-second-level users display-none">
                        ...
                        Students<span class="pull-right students-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="writers.php">
                        <i class="fa fa-edit fa-fw text-info fa-2x"></i>
                        Writers<span class="pull-right writers-sidebar"></span></a>
                        </li>
                        <li>
                        <a href="pending_writers.php">
                        <i class="fa fa-unlock fa-fw text-warning fa-2x"></i>
                        Pending Registrations<span class="pull-right writers-2-sidebar"></span></a>
                        </li>
                         <li>
                        <a href="suspended.php">
                        <i class="fa fa-lock fa-fw text-danger fa-2x"></i>
                        Suspended<span class="pull-right suspended-sidebar"></span></a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
            </li>
